...
public class CCGBankTaskTemplates extends CCGBankTaskFileGroup<FileList> {
	...
	enum Type {
		 ...
		 *         <code>".xml"</code> appended. Example: for
		 *         <code>LEXICON</code>, returns the string
		 *         <code>lexicon.xml</code>.
		 */
		String fileName() {
	...
	/**
	 * Gets the list of files contained in <code>group</code> as an array. The
	 * order of files in the returned array is the same as the order of
	 * <code>group</code>'s {@link FileList#getFiles(Project) files}.
	 */
	@Override
	 ...
	 * 
	 * @param typeName The name of the type to set. The actual type is coerced
	 *            using {@link Enum#valueOf(Class, String)} using
