...
public class ApposTally {
	...
	public String cueAnalysis() {
		...
		/*
		 * Stub to print a particular sentence if(id.equals("ID=wsj_0012.3")){
		 * System.out.println("Flag: "+flag); System.out.println(headInfo1);
		...
		// if(unit.contains("/CD") || unit.contains("/POS") ||
		// unit.contains("/IN") || unit.contains("/DT")|| unit.contains("PRP$")
		// || head1==true || cue==true)featInfo.add("appos");
