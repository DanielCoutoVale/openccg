...
/**
 * Class for representing groups of mappings during reading or writing. Mapping
 * groups encapsulate a phrase number (usually associated with a phrase's line
 * number) and a number of mappings in the group (its {@linkplain #getLength()
 * length}).
 * 
...
public class MappingGroup implements Comparable<MappingGroup> {
	 ...
	 * 
	 * @throws IllegalArgumentException if <tt>phraseNumber</tt> is
	 *             <tt>null</tt>, or if <tt>length &lt; 0</tt>.
	 */
	...
	/**
	 * Compares this mapping group to another by comparing their IDs and
	 * lengths.
	 */
	 ...
	 *         <code>12</code>, the string &quot;
	 *         <code>Group 37 (12 mappings)</code>&quot;.
	 */
	@Override
