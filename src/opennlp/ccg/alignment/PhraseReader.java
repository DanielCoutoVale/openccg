...
/**
 * A phrase reader just reads line numbers, but does not search for phrase IDs.
 * The line number of each phrase read is
 * {@linkplain IndexBase#translate(Integer, IndexBase) translated} into the
 * {@link IndexBase} provided at creation.
 * 
...
public class PhraseReader extends LineNumberReader {
	...
	/**
	 * Creates a phrase reader from the specified underlying reader and word
	 ...
	 * 
	 * @param numberBase The target phrase numbering base. Phrases read from the
	 *            underlying reader will have their numbers translated from
	 *            {@link #LINE_NUMBER_BASE the default} to
	 *            <code>numberBase</code>.
	...
	/**
	 * The target number base that new phrase IDs will have their line numbers
	 * translated into.
	 * 
	 * @see #readPhrase()
	 */
	 ...
	 * {@linkplain #getNumberBase() number base}. Note that this method may
	 * return a different result than {@link #getLineNumber()} due to the base
	 * translation.
	 * 
	 * @see IndexBase#translate(Integer, IndexBase)
	 */
	...
	/**
	 * Reads the next phrase from the underlying reader. The number is
	 * determined by translating the line number of the phrase into the
	 * {@linkplain #getNumberBase() target number base}. The words in the phrase
	 * are tokenized by the {@link Alignments#tokenize(String)} method.
	 * 
