...
public enum SRILMNgramModelType {
	/*
	 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!* It is very
	 * important that the order of these does not * change, as {@link
	 * SRILMNgramModel#loadLM(int, String, int)}* relies on the ordinal. *
	 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	 */

	/**
	 * A &quot;standard&quot; ngram model, of the type normally created by the
	 * SRILM binary <code>ngram-count</code>.
	 */
	STANDARD,
