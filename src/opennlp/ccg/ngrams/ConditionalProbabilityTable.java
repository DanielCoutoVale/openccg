 ...
 * (whether the pairs of attributes and values have anything to do with words or
 * not).
 *
...
public class ConditionalProbabilityTable {
	...
	public void setDebug(boolean debugScore) {
		model.setDebug(debugScore);
	}

	/**
	 * Returns a probability from the model for the given list of
	 * attribute-value pairs, which are assumed to have already been interned,
	...
	/**
	 * Returns a log probability from the model for the given list of
	 * attribute-value pairs, which are assumed to have already been interned.
