...
/**
 * A filter that matches vertices based on a basis vertex and a set of match
 * type criteria.
 * <p>
 * Instances of this class use the following match types:
 * {@link MatchType#SOURCE_MATCH}, {@link MatchType#SOURCE_MISMATCH},
 * {@link MatchType#TARGET_MATCH}, {@link MatchType#TARGET_MISMATCH},
 * {@link MatchType#SOURCE_PREDICATE_MATCH},
 * {@link MatchType#SOURCE_PREDICATE_MISMATCH},
 * {@link MatchType#TARGET_PREDICATE_MATCH},
 * {@link MatchType#TARGET_PREDICATE_MISMATCH}.
 * 
...
public class VertexMatchFilter extends MatchTypeFilter {
	...
	/**
	 * Creates a new vertex match filter using the specified vertex as a basis
	 * for comparison and the specified match type criteria.
	 * 
	...
	/**
	 * Gets the vertex that is the basis for comparison in this filter's
	...
	/**
	 * Tests whether a specified edge is allowed based on the match type
	 * criteria in effect and the vertex used as a basis for comparison.
	 * 
	 * @param edge The edge to test.
	 * @return <tt>false</tt> if {@link #getMatchTypes()} contains
	 *         <ul>
	 *         <li>{@link MatchType#SOURCE_MATCH}, but the basis edge does not
	 *         equal the edge's source,</li>
	 *         <li>{@link MatchType#SOURCE_MISMATCH}, but the basis edge is
	 *         equal to the edge's source,</li>
	 *         <li>{@link MatchType#TARGET_MATCH}, but the basis edge does not
	 *         equal the edge's target,</li>
	 *         <li>{@link MatchType#TARGET_MISMATCH}, but the basis edge is
	 *         equal to the edge's target,</li>
	 *         <li>{@link MatchType#SOURCE_PREDICATE_MATCH}, but the basis
	 *         edge's predicate does not equal the edge's source vertex's
	 *         predicate,</li>
	 *         <li>{@link MatchType#SOURCE_PREDICATE_MISMATCH}, but the basis
	 *         edge's predicate is equal to the edge's source vertex's
	 *         predicate,</li>
	 *         <li>{@link MatchType#TARGET_PREDICATE_MATCH}, but the basis
	 *         edge's predicate does not equal the edge's target vertex's
	 *         predicate,</li>
	 *         <li>{@link MatchType#TARGET_PREDICATE_MISMATCH}, but the basis
	 *         edge's predicate is equal to the edge's target vertex's
	 *         predicate,</li>
	 *         </ul>
