 ...
 * dates and times as English words. The class
 * com.sun.speech.freetts.en.us.NumberExpander served as a reference point in
 * part, but the implementation has been rewritten from scratch, streamlined and
 * extended.
 *
...
public class EnglishExpander {
	...
	/**
	 * Expands a date to English words in short, medium or long forms, adding
	 * the words to the given list. The style is given by DateFormat.SHORT
	 * (e.g., "the first"), DateFormat.MEDIUM (e.g., "the first of May"), and
	...
	/**
	 * Expands a time to English words, adding the words to the given list. For
	 * example, a date object with time set to 23:02 is expanded to
	 * "eleven oh two PM".
	 */
	...
	/**
	 * Expands a digit string and currency code to number words and the currency
	 * name, which are added to the given list. For example, "12.50" and "GBP"
	 * are expanded to "twelve pounds and fifty pence". The codes GBP, USD and
	 * EUR are converted to names, while other codes are left as is.
	 */
	...
	/**
	 * Expands a duration into a string of words. NB: Fractions of seconds are
	 * ignored at present.
	 */
	public static void expandDuration(Duration duration, List<String> list) {
		int[] durationFields = { duration.getYears(), duration.getMonths(), duration.getDays(),
	...
	/**
	 * Expands a digit string to a sequence of digit words, which are added to
	 * the given list. For example, "1234" is expanded to "one two three four".
	 */
	...
	/**
	 * Expands a digit string to number words, which are added to the given
	 * list. For example, "1234" is expanded to
	 * "one thousand two hundred and thirty four". The digit string may contain
	 * a single dot in it, as well as an initial plus or minus character. For
	 * example, "-100.011" is expanded to
	 * "minus one hundred point zero one one". Scientific notation is not
	 * currently handled.
	 */
	...
	/**
	 * Expands a digit string to words for an ordinal number, which are added to
	 * the given list. For example, "1234" is expanded to
	...
	private static final String[] zeroToNine = { "zero", "one", "two", "three", "four", "five",
			"six", "seven", "eight", "nine" };

	private static final String[] tenToNineteen = { "ten", "eleven", "twelve", "thirteen",
			"fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen" };

	private static final String[] zeroToNinety = { "zero", "ten", "twenty", "thirty", "forty",
			"fifty", "sixty", "seventy", "eighty", "ninety" };

	private static final String[] thousandToBillion = { "thousand", "million", "billion" };

	private static final String[] zerothToNinth = { "zeroth", "first", "second", "third", "fourth",
			"fifth", "sixth", "seventh", "eighth", "ninth" };

	private static final String[] tenthToNineteenth = { "tenth", "eleventh", "twelfth",
			"thirteenth", "fourteenth", "fifteenth", "sixteenth", "seventeenth", "eighteenth",
			"nineteenth" };

	private static final String[] zerothToNinetieth = { "zeroth", "tenth", "twentieth",
			"thirtieth", "fortieth", "fiftieth", "sixtieth", "seventieth", "eightieth", "ninetieth" };

	private static final String[] thousandthToBillionth = { "thousandth", "millionth", "billionth" };
