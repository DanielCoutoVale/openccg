...
/**
 * A licensing feature is one which controls the licensing and instantiation of
 * semantically null or marked categories in the realizer. Defaults are handled
 * in Lexicon.loadLicensingFeatures.
 *
...
public class LicensingFeature {
	...
	/**
	 * A flag indicating whether semantically null categories with the licensing
	 * feature need to be licensed.
	 */
	public final boolean licenseEmptyCats;

	/**
	 * A flag indicating whether initial categories with the licensing feature
	 * are marked and need to be licensed.
	 */
	...
	/**
	 * The location of the licensing feature on the category to be licensed. The
	 * value must be one of TARGET_ONLY, ARGS_ONLY or BOTH.
	 */
	...
	/**
	 * Location of the feature on either the target category or the argument
	 * categories.
	 */
	public static final byte BOTH = 0;

	/** Constructor. */
	public LicensingFeature(String attr, String val, List<String> alsoLicensedBy,
			boolean licenseEmptyCats, boolean licenseMarkedCats, boolean instantiate, byte loc) {
		this.attr = attr;
		this.val = val;
	...
	/** Default lex feature. */
	public static final LicensingFeature defaultLexFeature = new LicensingFeature("lex", null,
			null, true, false, true, BOTH);

	/** Simple lex feature, for comparison purposes. */
	public static final LicensingFeature simpleLexFeature = new LicensingFeature("lex", null, null,
