...
/**
 * EdgeCombos is a simple data structure that allows a representative edge to
 * collect the info about successful combinations of the edge (with other edges
 * or unary rules) that is needed to create analogous new result edges for edges
 * that share the same category, without having to invoke the combinatory rules.
 *
