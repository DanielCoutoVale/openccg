 ...
 * point in a model. The type is checked for compatibility during unification
 * with nominal vars, but it is not updated, since nominal atoms are constants.
...
public class NominalAtom extends HyloAtom implements Nominal {
	...
	/**
	 * Returns whether this atom equals the given object based on the atom name
	 * and type.
	 */
