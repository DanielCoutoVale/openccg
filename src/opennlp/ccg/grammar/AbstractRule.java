...
public abstract class AbstractRule implements Rule, Serializable {
	...
	/**
	 * Applies the rule to the given input signs, adding to the given list of
	 * results.
	 */
	...
	protected void distributeTargetFeatures(Category cat) {
		if (_ruleGroup == null)
			return;
		if (_ruleGroup.grammar.lexicon.getDistributiveAttrs() == null)
			return;
	...
	/**
	 * Appends, fills, sorts and checks the LFs from cats 1 and 2 into the
	 * result cat.
	 */
