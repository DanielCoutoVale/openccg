...
public class Types {
	...
	/**
	 * Constructs the type hierarchy from the given URL, for the given grammar.
	 */
	...
	/**
	 * Returns the simple type with the given name, or a new one if none yet
	 * exists.
	 */
	...
	/**
	 * Returns the list of types, with parents preceding children in the
	 * hierarchy.
	 */
	...
	private void readTypes(List<Element> _types) {
		...
		GroupMap<String, String> hierarchy = new GroupMap<String, String>(); // map
																				// from
																				// types
																				// to
																				// all
																				// subtypes
		GroupMap<String, String> parents = new GroupMap<String, String>(); // map
																			// from
																			// types
																			// to
																			// parents
		TObjectIntHashMap depthMap = new TObjectIntHashMap(); // map from types
																// to max depth
		...
		if (parentSet != null) {
			for (String parent : parentSet) {
				if (parent.equals(startType)) {
					throw new RuntimeException("Error, type hierarchy contains cycle from/to: "
							+ startType);
				}
	...
	/**
	 * Computes the list of all sub-types of a given type (key) in depth-first
	 * order.
	 */
	...
	/**
	 * Creates the SimpleType objects and constructs the nameToType and
	 * indexToType maps.
	 */
