...
/**
 * An unmodifiable list of one element. Equality is checked using == on the list
 * element, which is assumed to be canonical.
 *
...
public class SingletonList<T> extends AbstractList<T> implements Serializable {
	...
	public T get(int i) {
		if (i == 0)
			...
			throw new IndexOutOfBoundsException("No element with index: " + i);
	}

	/**
	 * Returns a hash code for this list, using the identity hash code of the
	 * list element.
	 */
	public int hashCode() {
