...
/**
 * A map where putting a value does not replace an old value but is instead
 * included in a list of values for that key. The map may use identity equals on
 * keys. (NB: A ListMap is essentially a GroupMap that uses lists instead of
 * sets.)
 *
...
public class ListMap<KeyType, ValType> {
	...
	/**
	 * Constructor with flag for whether to use identity instead of
	 * <code>equals</code> on keys.
	 */
