...
public interface FeatureStructure extends Unifiable, Mutable {
	...
	/**
	 * Checks to see if the feature structure contains a feature with the given
	 * attribute.
	 *
	...
	/**
	 * Computes whether this feature structure contains (is a superset of)
	...
	/**
	 * Changes this feature structure such that all its features that are in
	 * another feature structure are changed to have the values of the other
	 * feature structure. This is destructive.
	 *
